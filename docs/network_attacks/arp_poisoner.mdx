...
- Create config.json under /arp_poisoner path like [this](/example_config/arp_poisoner/example.json) with SSID and password of AP to connect then target IP in the form of array and MAC address in the form of array(convert HEX to decimal like the example config since JSON doesn't support HEX.)
